...
export default function LoginPage() {
  ...
  const inputCls = (err) =>
    `w-full rounded-lg border px-3 py-2.5 text-sm text-stone-800 placeholder-stone-400 outline-none transition focus:ring-2 focus:ring-amber-400 focus:border-amber-400 ${
      err ? "border-red-400 bg-red-50" : "border-stone-300 bg-white hover:border-stone-400"
    }`;
    ...
    <div className="min-h-screen bg-stone-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-stone-200 p-8">
          <h1 className="text-xl font-semibold text-stone-800 mb-6">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              <div className="flex items-start gap-3">
                ...
                <div className="relative flex-1">
                  <input type={showPassword ? "text" : "password"} name="password" value={form.password} onChange={handleChange} placeholder="Your password" className={inputCls(fieldErrors.password) + " pr-10"} />
            ...
            <div className="flex flex-col items-center gap-3 ml-[8.5rem]">
              ...
              <span className="text-sm text-stone-500">
                ...
                <Link to="/register" className="font-medium text-amber-600 hover:underline">Create one</Link>
              </span>
            </div>
